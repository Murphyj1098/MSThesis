...
% OMNeT++
OMNeT++ is another discrete event simulator written in C++, like ns-3, however, it is not explicitly designed as a communications network simulator~\cite{omnet++}.
