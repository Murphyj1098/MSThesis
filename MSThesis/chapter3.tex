...
\section{Compare EMANE results to real test-bed?}
    % Are the measured throughputs and latencies the same in hardware and in EMANE?
    % Sorta, OVERCOME is slightly difference because it is designed for customer use (uplink and downlink are not symmetric, but total throughput is kinda similar, read: better hardware)
