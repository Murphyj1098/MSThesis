...
With the radio plugins configured in the NEMs, two EMANE environments were created for the OVERCOME testbed and three were created for the ZoomTEL testbed.
